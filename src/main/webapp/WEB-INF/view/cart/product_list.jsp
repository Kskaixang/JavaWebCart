				...
				<td valign="top">
					<fieldset>
						...
						<table class="pure-table">
							...
							<tbody>
								<c:forEach var="productDTOs" items="${ productDTOs }">
									<tr>
										<th>${ productDTOs.productId }</th>
										<th>${ productDTOs.productName }</th>
										<th>${ productDTOs.price }</th>
										<th>${ productDTOs.qty }</th>
										<th>${ productDTOs.total }</th>
										<th>${ productDTOs.imageBase64 }</th>
										<th>刪除</th>
									</tr>
